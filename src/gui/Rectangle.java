...
public class Rectangle extends CenteredGraphicalElement
{
    ...
    public Rectangle(int paramInt1, int paramInt2, Color paramColor1, Color paramColor2, int paramInt3, int paramInt4) {
    ...
    public Rectangle(int paramInt1, int paramInt2, Color paramColor1, Color paramColor2, int paramInt3) {
    ...
    public void paint(Graphics2D paramGraphics2D) {
        ...
        paramGraphics2D.fillRect(getX() - this.width / 2, getY() - this.height / 2, this.width, this.height);
        } 
        paramGraphics2D.setColor(this.drawColor);
        paramGraphics2D.drawRect(getX() - this.width / 2, getY() - this.height / 2, this.width, this.height);
